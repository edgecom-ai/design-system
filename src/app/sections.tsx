...
import { ChartLegacyPaletteDemo } from "@/components/demo/chart-legacy-palette-demo";
...
// Legacy line-palette hues (migration only), with the peak rank that aliases each one.
