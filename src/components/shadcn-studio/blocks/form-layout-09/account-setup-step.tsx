...
import type { AccountSetupValues, StepperType } from '@/components/shadcn-studio/blocks/form-layout-09/form-layout-09'
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid} className='gap-2 sm:col-span-2'>
                ...
                <Input {...field} id={field.name} aria-invalid={fieldState.invalid} placeholder='Priya Sharma' />
