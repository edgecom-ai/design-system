              ...
              <DialogHeader>
                <div className='space-y-1'>
                  ...
                  <DialogDescription className='text-sm'>
                    Generate a new API key to access the Edgecom Energy API. Keep this key secure and never share it
                    publicly.
                  </DialogDescription>
                </div>
              </DialogHeader>
