...
const steps = [
  {
    number: 1,
    title: 'Select Facility & Meters',
    description: 'Choose the dataTrack™ site and meters to enroll.',
    options: ['All dataTrack™ sites', 'Manufacturing Plant', 'Distribution Center', 'Head Office'],
    defaultValue: 'All dataTrack™ sites'
  },
  {
    number: 2,
  ...
  {
    number: 3,
    title: 'Select Baseline Method',
    description: 'Choose how curtailment baselines are calculated.',
    options: ['Average of last 5 days', 'Weather-adjusted', 'Regression', 'High 5 of 10 days', 'Manual baseline'],
    defaultValue: 'Average of last 5 days'
  },
  {
    number: 4,
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <div className='bg-background sticky top-0 z-10 flex shrink-0 items-center border-b px-6 py-4 pr-12'>
          <DialogTitle className='text-lg font-semibold'>Configure Demand Response program</DialogTitle>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-[1fr_auto_1.6fr]'>
            ...
            <div className='flex flex-col p-6'>
              <div className='mb-6'>
                ...
                <p className='text-base font-semibold'>Program Enrollment</p>
                <p className='text-muted-foreground text-sm'>Enroll sites in curtailment events</p>
              </div>
              ...
              <div className='mb-5'>
                ...
                <p className='text-muted-foreground text-sm'>
                  Set up automated Demand Response dispatch across your dataTrack™ sites.
                </p>
              </div>

              <div>
                <p className='mb-1 text-sm font-medium'>Info</p>
                <p className='text-muted-foreground text-sm'>Reduce peak demand and earn curtailment revenue.</p>
              </div>
            </div>
        ...
        <div className='bg-background sticky bottom-0 z-10 flex shrink-0 flex-col-reverse items-center gap-4 border-t px-6 py-4 sm:flex-row sm:justify-end'>
          ...
          <DialogClose render={<Button className='max-sm:w-full' />}>Enroll Program</DialogClose>
        </div>
      </DialogContent>
    </Dialog>
  )
