    ...
    <div>
      <div className='grid grid-cols-1 gap-10 lg:grid-cols-3'>
        ...
        <div className='flex flex-col space-y-1'>
          <h3 className='font-semibold'>Portal Name & TimeZone</h3>
          <p className='text-muted-foreground text-sm'>Manage your energy portal name and time zone settings.</p>
        </div>
        {/* Content */}
        <div className='space-y-6 lg:col-span-2'>
          {/* Workspace Name */}
          <div className='flex flex-col items-start gap-1'>
            <Label htmlFor='workspace-name'>Portal Name</Label>
            <Input id='workspace-name' placeholder='Acme Energy' defaultValue='Acme Energy' />
          </div>
          {/* Workspace ID */}
