  ...
  const organizations = [
    {
      ...
      description: 'connected for energy reports and M&V documentation'
    },
    {
      id: 'github',
      name: 'Github',
      img: 'https://cdn.shadcnstudio.com/ss-assets/brand-logo/github-white.png',
      description: 'connected for automation scripts and data exports'
    },
    {
      id: 'discord',
      name: 'Discord',
      img: 'https://cdn.shadcnstudio.com/ss-assets/brand-logo/discord-icon.png',
      description: 'connected for peak demand and alarm notifications'
    }
  ]
    ...
    <div>
      <div className='grid grid-cols-1 gap-10 lg:grid-cols-3'>
        ...
        <div className='flex flex-col space-y-1'>
          ...
          <p className='text-muted-foreground text-sm'>Manage the apps connected to your energy portal.</p>
        </div>
        {/* Content */}
