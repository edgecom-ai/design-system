    ...
    <div>
      <div className='grid grid-cols-1 gap-10 lg:grid-cols-3'>
        ...
        <div className='flex flex-col space-y-1'>
          <h3 className='font-semibold'>Export energy data</h3>
          <p className='text-muted-foreground text-sm'>
            Export your consumption, cost, and emissions data for backup or reporting purposes.
          </p>
        </div>
        {/* Content */}
