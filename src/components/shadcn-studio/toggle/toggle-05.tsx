...
import { HeartIcon, ThumbsUp, StarIcon, ArrowBigUpIcon } from "lucide-react"

const ToggleFilledIcon = () => {
  return (
    <div className='flex items-center gap-2'>
      <Toggle aria-label='Toggle heart' variant='outline' className='group/toggle'>
        <HeartIcon className='group-data-[pressed]/toggle:fill-destructive group-data-[pressed]/toggle:stroke-destructive group-data-[pressed]/toggle:text-destructive' />
      </Toggle>
