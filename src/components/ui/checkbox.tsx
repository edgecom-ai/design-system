...
function Checkbox({ className, ...props }: CheckboxPrimitive.Root.Props) {
  return (
    ...
    >
      ...
      >
        <CheckIcon
          className="group-data-indeterminate/checkbox-indicator:hidden"
        />
        <MinusIcon
