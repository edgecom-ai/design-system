...
Contracts at **v1.0.0**, digest `3a27629e9107153a` — 56 components, 12 with authored selection criteria. The version and digest are stamped into every file below; a design or an app built against a different digest is working from a different system.
...
| [schemas/](https://design.edgecom.ai/schemas/contracts.schema.json) | The JSON Schemas both files validate against. |
