...
Contracts at **v1.1.0**, digest `291720b473457638` — 65 components, 13 with authored selection criteria. The version and digest are stamped into every file below; a design or an app built against a different digest is working from a different system.
